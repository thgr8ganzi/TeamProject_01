		...
		<div class="row">
			<form method="post" action="writeAction.jsp">
				<table class="table table-striped"
					...
					<thead>
						<tr>
							<th colspan="2" style="background-color: #eeeeee; color: black; text-align: center;">게시판 글쓰기</th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							<td><textarea class="form-control" placeholder="글내용" name="bbsContent" maxlenght="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
